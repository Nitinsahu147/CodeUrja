...
<head>
    ...
    <title>Volunteer Login - National Disaster Management Platform</title>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark navbar-gov">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="volunteer_login.jsp">Volunteer Login</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="login-container">
            <h2 class="text-center mb-4">Volunteer Login</h2>
            <%
        ...
        <% } %>
        <form action="VolunteerLoginServlet" method="post">
                <div class="mb-3">
                    <label for="volunteerId" class="form-label">Volunteer ID</label>
                    <input type="email" name="email" class="form-control" id="volunteerId" required>
                </div>
                <div class="mb-3">
                ...
                <div class="text-center mt-3">
                    <a href="#" class="text-decoration-none">Forgot Volunteer ID?</a>
                </div>
                <div class="text-center mt-3">
                    <p>Agency Login? <a href="login.jsp" class="text-decoration-none">Login Here</a></p>
                </div>
            </form>
        </div>
    </div>
