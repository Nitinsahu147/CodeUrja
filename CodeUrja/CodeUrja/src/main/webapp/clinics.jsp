   ...
   <div class="container-fluid bg-light py-2 text-center header-container">
    ...
    <div class="container">
        ...
        <div class="row">
            <%
                String[][] hospitals = {
                    {"City Hospital", "MG Road, Indore", "Dr. Sharma, Dr. Verma", "Emergency, Surgery, OPD"},
                    {"Apollo Clinic", "Vijay Nagar, Indore", "Dr. Mehta, Dr. Kapoor", "Diagnostics, General Medicine"},
                    {"Sunrise Hospital", "Palasia, Indore", "Dr. Reddy, Dr. Malhotra", "Maternity, Pediatrics, ICU"},
                    {"Global Care Clinic", "Bhawarkua, Indore", "Dr. Khan, Dr. Gupta", "Dental, Physiotherapy, OPD"},
                    {"Medicover Hospital", "Rajwada, Indore", "Dr. Saxena, Dr. Dubey", "Cardiology, Surgery"}
                };
                
                for (int i = 0; i < 50; i++) {
                    int index = i % hospitals.length;
            %>
            <div class="col-md-4">
                <div class="card p-3">
                    <h5><%= hospitals[index][0] %></h5>
                    <p><strong>Location:</strong> <%= hospitals[index][1] %></p>
                    <p><strong>Doctors:</strong> <%= hospitals[index][2] %></p>
                    <p><strong>Services:</strong> <%= hospitals[index][3] %></p>
