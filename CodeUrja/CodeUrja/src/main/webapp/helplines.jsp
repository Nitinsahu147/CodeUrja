...
<head>
  ...
  <link rel="stylesheet" href="https://unpkg.com/aos@next/dist/aos.css" />
    <title>Emergency Helplines & Ambulance Services</title>
...
<body>
   ...
   <div class="container-fluid bg-light py-2 text-center header-container">
    ...
    <div class="container">
        <h2 class="text-center mb-4">Emergency Helpline Numbers & Ambulance Services</h2>
        <div class="row">
            <% 
                String[][] helplines = {
                    {"National Disaster Helpline", "+91-1078"},
                    {"Emergency Ambulance", "+91-108"},
                    {"Fire Brigade", "+91-101"},
                    {"Police Emergency", "+91-100"},
                    {"Child Helpline", "+91-1098"},
                    {"Women Helpline", "+91-181"},
                    {"Blood Bank Services", "+91-104"},
                    {"COVID-19 Helpline", "+91-1075"},
                    {"State Disaster Response", "+91-112"},
                    {"Earthquake & Flood Relief", "+91-1096"}
                };
            ...
            <div class="col-md-4">
                <div class="card p-3">
                    <h5><%= helplines[i][0] %></h5>
                    <p><strong>Contact:</strong> <%= helplines[i][1] %></p>
                    <a href="tel:<%= helplines[i][1] %>" class="btn btn-danger">Call Now</a>
                </div>
            </div>
            <% } %>
        </div>
