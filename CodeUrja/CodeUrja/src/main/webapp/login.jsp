        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="login.jsp">Agency Login</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="row shadow-lg p-4 rounded bg-white">
            <div class="col-md-6 d-flex align-items-center">
                <img src="https://png.pngtree.com/png-clipart/20231007/original/pngtree-federal-government-building-vector-line-icon-png-image_12976264.png" alt="Agency Login" class="img-fluid w-100">
            </div>
            <div class="col-md-6">
                ...
                <form action="LoginServlet" method="post">
                    ...
                    <div class="text-center mt-3">
                        <a href="#" class="text-decoration-none">Forgot Agency Credentials?</a>
                    </div>
                    <div class="text-center mt-3">
                        <p>Volunteer Login? <a href="volunteer_login.jsp" class="text-decoration-none">Login Here</a></p>
                    </div>
                </form>
            </div>
        </div>
