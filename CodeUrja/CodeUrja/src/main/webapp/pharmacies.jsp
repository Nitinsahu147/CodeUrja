...
<head>
  ...
  <link rel="stylesheet" href="https://unpkg.com/aos@next/dist/aos.css" />
    <title>Nearby Pharmacies & Medical Stores</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="pharmacies.jsp">Pharmacies </a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <h2 class="text-center mb-4">Nearby Pharmacies & Medical Stores</h2>
        <div class="row">
            <%
                String[][] pharmacies = {
                    {"MediCare Pharmacy", "Vijay Nagar, Indore", "Open", "+91-9876543210", "Mr. Sharma"},
                    {"Health Plus Medicals", "MG Road, Indore", "Closed", "+91-8765432109", "Dr. Verma"},
                    {"Lifeline Pharmacy", "Palasia, Indore", "Open", "+91-7654321098", "Mrs. Kapoor"},
                    {"Wellness Chemist", "Bhawarkua, Indore", "Open", "+91-6543210987", "Mr. Khan"},
                    {"City Medical Store", "Rajwada, Indore", "Closed", "+91-5432109876", "Mr. Saxena"}
                };

                for (int i = 0; i < 20; i++) {
                    String[] pharmacy = pharmacies[i % pharmacies.length];
            %>
            <div class="col-md-4">
                <div class="card p-3">
                    <h5><%= pharmacy[0] %></h5>
                    <p><strong>Location:</strong> <%= pharmacy[1] %></p>
                    <p><strong>Status:</strong> <span class="<%= pharmacy[2].equals("Open") ? "open" : "closed" %>"><%= pharmacy[2] %></span></p>
                    <p><strong>Owner:</strong> <%= pharmacy[4] %></p>
                    <p><strong>Contact:</strong> <%= pharmacy[3] %></p>
                    <a href="tel:<%= pharmacy[3] %>" class="btn btn-primary">Call Now</a>
                </div>
            </div>
            <% } %>
        </div>
